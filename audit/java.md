# Audit State — Java (`arcis-java`)

**Status:** ⬜ NOT STARTED
**Last audited:** never
**Test count:** unknown
**Package path:** `packages/arcis-java`
...
| Feature | Java | Node.js baseline | Match? |
|---------|------|-----------------|--------|
